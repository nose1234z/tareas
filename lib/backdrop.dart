...
import 'login.dart'; // --- NUEVO: Import para LoginPage ---
...
class _BackdropState extends State<Backdrop>
  ...
  Widget build(BuildContext context) {
    var appBar = AppBar(
      elevation: 0.0,
      titleSpacing: 0.0,
      // --- CAMBIO: Se reemplaza el título y se elimina 'leading' ---
      ...
      // --- CAMBIO: Se añade la navegación en los botones de acción ---
      actions: <Widget>[
        IconButton(
...
// --- NUEVO: Se añade la clase _BackdropTitle al final ---
